/*
  ...
  - You are about to drop the column `benefit_id` on the `anime` table. All the data in the column will be lost.
...
INSERT INTO "new_anime" ("anilist_id", "badge", "content_id", "created_at", "description", "entity_type", "expired_at", "expiring_season", "id", "image_url", "is_identified", "maturity_rating", "next_episode_date", "provider", "quarter", "recorded", "scheduled", "status", "title", "updated_at", "year") SELECT "anilist_id", "badge", "content_id", "created_at", "description", "entity_type", "expired_at", "expiring_season", "id", "image_url", "is_identified", "maturity_rating", "next_episode_date", "provider", "quarter", "recorded", "scheduled", "status", "title", "updated_at", "year" FROM "anime";
DROP TABLE "anime";
